...
impl Default for NnueEvaluator {
    fn default() -> Self {
        Self::new_dummy(banqi_core::core::env::darkchess_config().nnue_feature_dim())
    }
}
...
impl NnueEvaluator {
    ...
    /// 基于双累加器与视角求值。
    #[inline]
    pub fn evaluate_dual(&self, dual: &super::feature::DualAccumulator, player: banqi_core::core::env::types::Player) -> f32 {
...
mod tests {
    ...
    fn test_infer_feature_dim_roundtrip() {
        let dim = banqi_core::core::env::darkchess_config().nnue_feature_dim();
...
impl NnueBoard {
    ...
    pub fn step(
        &mut self,
        action: usize,
        reveal_piece: Option<banqi_core::core::env::types::Piece>,
